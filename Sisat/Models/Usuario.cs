...
namespace Sisat.Models
{
    public partial class Usuario
    {
        ...
        [InverseProperty(nameof(Chat.IdDestinatarioNavigation))]
        public virtual ICollection<Chat> ChatIdDestinatarioNavigation { get; set; }

        [InverseProperty(nameof(Chat.IdRemetenteNavigation))]
        public virtual ICollection<Chat> ChatIdRemetenteNavigation { get; set; }
